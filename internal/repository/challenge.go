...
type ChallengeRepository interface {
	...
	GetByAddress(ctx context.Context, address string) (*model.Challenge, error)
	Update(ctx context.Context, challenge *model.Challenge) error
	Upsert(ctx context.Context, challenge *model.Challenge) error
...
func (r *ChallengeStore) Create(ctx context.Context, challenge *model.Challenge) error {
...
func (r *ChallengeStore) GetByAddress(ctx context.Context, address string) (*model.Challenge, error) {
...
func (r *ChallengeStore) Update(ctx context.Context, challenge *model.Challenge) error {
	query := `UPDATE challenges SET nonce = :nonce, created_at = :created_at WHERE address = :address`
	_, err := r.db.NamedExecContext(ctx, query, challenge)
	return err
}

func (r *ChallengeStore) Upsert(ctx context.Context, challenge *model.Challenge) error {
